...
TwistBot4 edit:
These collide with my Gem color enums.
...
// TwistBot4 edit:
// I wasn't sure if I'd need to use BLANK anywhere in my code, so I just made this not collide with BLANK. idunno
#define RLIB_BLANK      CLITERAL(Color){ 0, 0, 0, 0 }           // Blank (Transparent)
